<%-- 
    Document   : ReportMubleMenosVend
    Created on : 3/09/2021, 02:19:36
    Author     : david
--%>
  ...
  <div class="d-flex">
            ...
            <div class="card-body"> 
                <form> 
                     ...
                     <center> <label>BUSCAR MUEBLE MAS VENDIDO</label></center>
                     <label></label>    
                     <div class="form-group">
...
%>
            ...
            <div class="col-sm-8">
        <h4>   <center> <label> REPORTE DE MUEBLES MAS VENDIDOS POR FECHAS</label></center></h4>
        <br>
